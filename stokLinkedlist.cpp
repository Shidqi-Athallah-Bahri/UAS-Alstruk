...
// Fungsi untuk menghapus menu dari linked list
...
// fugsi ini mengambil input dari user untuk menambah menu baru
void tambahMenu(){
    string namaMenu;
    int jumlahStok;
...
//fungsi ini mengambil input dari user untuk menghapus menu
void hapusMenu(){
    string namaMenu;
